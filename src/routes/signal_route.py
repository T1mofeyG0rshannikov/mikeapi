...
from src.schemas.signal import GetSignalsRequest, SignalsResponse
from src.dependencies.dependencies import DeviceAnnotation, get_device_get, get_signal_repository
from src.exceptions import APIServerError, ObjectNotFound
...
async def get_signals(
    ...
    #try:
        ...
        signals = await signal_repository.filter(ticker_slugs=tickers, trader_ids=inds)
