...
from src.web.routes.deal_route import router as deal_router
from src.web.routes.traders_route import router as traders_router
from src.web.routes.signal_route import router as signal_router
from src.web.routes.ticker_route import router as ticker_router
